    ...
    <div className="max-w-3xl">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2 border border-gray-200 rounded-lg px-3 py-2 focus-within:border-red-400 transition-colors">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="block w-full pl-9 pr-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-red-400 transition-colors"
          />
        </div>
        {!search && (
          <select
            ...
            className="border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-red-400 transition-colors text-black"
          >
            {DEPARTMENTS.map(d => (
              ...
              return (
                <div key={`${department}-${municipality}`} className="flex items-center justify-between px-5 py-3 hover:bg-gray-50/70 transition-colors">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-1 border border-gray-200 rounded-lg px-2 py-1 focus-within:border-red-400 transition-colors">
