      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 grid grid-cols-[1fr_auto_1fr] items-center gap-4">
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="flex flex-col leading-tight min-w-0">
            <span
              className="text-base text-black leading-none truncate"
        ...
        {/* ── Derecha: botón carrito pill ── */}
        <div className="flex justify-end">
          <button
            onClick={openSidebar}
            className="relative flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white pl-4 pr-5 py-2 rounded-full text-xs font-semibold uppercase tracking-wide transition-colors"
